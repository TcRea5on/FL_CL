...
def args_parser():
    ...
    parser.add_argument('--global_ep', type=int, default=5, help="the number of global epochs: E")
    parser.add_argument('--local_bs', type=int, default=20, help="local batch size: B")
    parser.add_argument('--global_bs', type=int, default=50, help="global batch size: B")
    parser.add_argument('--bs', type=int, default=128, help="test batch size")
    parser.add_argument('--lr', type=float, default=0.01, help="learning rate")
    parser.add_argument('--g_lr', type=float, default=0.005, help="global learning rate")
